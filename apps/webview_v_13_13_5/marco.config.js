module.exports = {
  android: {
    packageName: 'com.webview_v_13_13_5', // Update if your package name is different
  ...
  ios: {
    packageName: 'org.reactjs.native.example.webviewv13135', // Update if your package name is different
